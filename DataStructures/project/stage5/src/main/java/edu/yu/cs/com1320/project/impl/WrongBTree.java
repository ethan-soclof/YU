 ...
 * NOTE: Edited by Judah Diament to increase readability (renamed variables, added comments, formatting, etc.).
 * Also added the capabilities for getOrderedEntries, getMaxEntry, getMinEntry
