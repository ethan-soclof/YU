...
public class StackImplTest {
    ...
    public void initVariables() throws URISyntaxException {
        ...
        URI uri3 = new URI("http://www.test3.net");
        this.cmd3 = new Command(uri3, target ->{
            return target.equals(uri3);
        });
        URI uri4 = new URI("http://www.test4.net");
        this.cmd4 = new Command(uri4, target ->{
            return target.equals(uri4);
        });*/
        this.stack.push(this.cmd1);
        this.stack.push(this.cmd2);
        /*this.stack.push(this.cmd3);
        this.stack.push(this.cmd4);*/
    }
    ...
    public void pushAndPopTest(){
        ...
        assertEquals("first pop should've returned 4th command",this.cmd4,pcmd);
        pcmd = stack.pop();
        assertEquals("second pop should've returned 3rd command",this.cmd3,pcmd);
        pcmd = stack.pop();
        assertEquals("second pop should've returned 2nd command",this.cmd2,pcmd);
        pcmd = stack.pop();
        assertEquals("second pop should've returned 1st command",this.cmd1,pcmd);
